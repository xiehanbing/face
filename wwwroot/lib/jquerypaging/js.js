...
(function () {
    var dmm = function (options1) {
        ...
        Objarr.push(Obj1);
        var sele = "<div class='selPa'><select class='w-select' id='" + options.container + "_w-select' onchange='changess(" + JSON.stringify(Obj1) + ")'></div>";
...
function xian(obj) {
    ...
    var shoustr = "<button id='" + obj.container + "_btnFirst' type='button' class='button gray firstPage' onclick='page(" + JSON.stringify(obj) + ",1)'>首页</button>" +
    ...
    if (obj.isSkip) {
        ...
        shoustr += "<button id='" + obj.container + "_btnEnd' type='button' class='button gray lastPage' onclick='page(" + JSON.stringify(obj) + ",4)'>尾页</button>&nbsp;&nbsp;页数：" + (obj.infocount==0?0:obj.index) + " / " + obj.countpage + " &nbsp;&nbsp;&nbsp;总条数：" + obj.infocount + "</span>";
    }
